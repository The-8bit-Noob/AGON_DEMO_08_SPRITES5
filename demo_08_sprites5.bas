   ...
   50 REM *       SPRITES PART 5       *
   60 REM *   NEEDS SPED >1.01 RGBA8   *
  ...
  220 PROC_LOAD_BITMAP("/B/Images/abombr1.rgb",0,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
  230 PROC_LOAD_BITMAP("/B/Images/abombr2.rgb",1,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
  240 PROC_LOAD_BITMAP("/B/Images/abombl1.rgb",2,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
  250 PROC_LOAD_BITMAP("/B/Images/abombl2.rgb",3,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
  260 PROC_LOAD_BITMAP("/B/Images/abombud1.rgb",4,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
  270 PROC_LOAD_BITMAP("/B/Images/abombud2.rgb",5,16,16) : REM CALL PROC_LOAD_BITMAP (n,w,h).
 ...
 2540 FOR I%=0 TO (W%*H%*4)-1 STEP 4 : REM LOOP 16x16x4 EACH PIXEL R,G,B,A (-1 because we start the loop at 0).
 ...
 2580   a% = ?(GRAPHICS+I%+3) : REM GET ALPHA DATA WITH QUERY & ASSIGN TO a%.
